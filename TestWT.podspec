#
#  Be sure to run `pod spec lint TestWT.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "VictorerW"
  # s.authors            = { "VictorerW" => "623328266@qq.com" }
  ...
  s.source       = { :git => "https://github.com/VictorerW/TestWT.git", :tag => "#{s.version}" }
